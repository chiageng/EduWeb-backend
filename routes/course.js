...
import { uplaodImage, removeImage, create, viewInstructorCourses, viewCourse, uploadVideo, removeVideo, createTopic, editCourse } from "../controllers/course";
...
router.post("/course/video-upload", verify, isInstructor, formidable(), uploadVideo)
